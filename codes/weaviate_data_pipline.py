...
weaviate_url = "https://brown-cs-oecbd68e.weaviate.network"
...
link_data_collections = load_data_from_json("data/scraped_data_test_malte.json")
...
for key, url_dic in link_data_collections.items():
    ...
    object_to_add = {"class": class_name, "properties": metadata, "vector": embedding}
